          ...
          <div className="bg-white/85 backdrop-blur-xl rounded-3xl shadow-2xl shadow-green-900/15 border border-white/70 p-7">
            ...
            <div className="space-y-2 mb-5">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 rounded-xl text-sm font-medium text-slate-700 transition-all shadow-sm disabled:opacity-60 disabled:cursor-not-allowed login-allura text-lg"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-[#1877F2] hover:bg-[#166fe5] rounded-xl text-sm font-medium text-white transition-all shadow-sm disabled:opacity-60 disabled:cursor-not-allowed login-allura text-lg"
              >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="login-allura text-xl text-slate-400">or</span>
              <div className="flex-1 h-px bg-slate-200" />
            </div>
